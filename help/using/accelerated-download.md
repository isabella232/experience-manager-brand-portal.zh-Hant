...
## 使用檔案加速器下載工作流 {#download-workflow-using-file-accelerator}
...
1. 的 **[!UICONTROL 下載]** 列出所有選定資產的對話框。
   ...
   下載按鈕反映所選項的計數。 完成應用規則後，按一下 **[!UICONTROL 下載項目]**。 有關如何應用規則的詳細資訊，請參閱 [下載資產](../using/download-assets.md#download-assets)。
