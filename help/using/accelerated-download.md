...
>[!NOTE]
>
>IBM Aspera Connect有已知問題。 快速下載無法與IBM Aspera Connect 3.10版及更新版本搭配使用。
...
在IBM Aspera Connect Client偏好設定中，以滑鼠右鍵按一下圖示並選取「 」，即可設定一些實用偏好設定 **[!UICONTROL 偏好設定]**.
...
1. 通過訪問檢查埠是否未被阻止 [https://test-connect.asperasoft.com](https://test-connect.asperasoft.com/) 從你的機器上。
