...
title: 支援的檔案格式
seo-title: 支援的檔案格式
description: '每個AEM Assets Brand Portal都支援特定檔案格式，如矩陣中所示。 '
seo-description: '每個AEM Assets Brand Portal都支援特定檔案格式，如矩陣中所示。 '
uuid: c92ada3a-6fc3-4ef2-88ff-8e67a50c
content-type: 引用
...
| 檔案格式 | 發佈至品牌入口網站的資產 | 發佈至品牌入口網站的轉譯 | 發佈至品牌入口網站的中繼資料 | 發佈至品牌入口網站的縮圖 | 發佈至品牌入口網站的資產詳細資料頁面 | 連結分享 | 連結共用縮圖 | 連結共用預覽 |
|-------------|----------------------------------|--------------------------------------|------------------------------------|--------------------------------------|-----------------------------------------------|-------------|-----------------------|---------------------|
| PNG | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| GIF | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| TIFF | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✕ |
