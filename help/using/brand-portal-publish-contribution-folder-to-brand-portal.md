---
title: '從Experience Manager資產設定及發佈貢獻資料夾至Brand Portal '
seo-title: Configure and publish contribution folder from Experience Manager Assets to Brand Portal
description: 從「Experience Manager資產」深入分析如何設定及發佈貢獻資料夾至Brand Portal。
...
# 在Experience Manager資產中設定貢獻資料夾 {#configure-contribution-folder}

對於協作資產來源補充，Experience Manager資產使用者（管理員和非擁有權限的管理員使用者）可以建立類型&#x200B;**資產貢獻**&#x200B;的新資料夾，確保所建立的新資料夾可供Brand Portal使用者提交資產。  這會自動觸發在新建立的&#x200B;**Contribution**&#x200B;資料夾內建立另外兩個子資料夾（稱為&#x200B;**SHARED**&#x200B;和&#x200B;**NEW**）的工作流程。

Experience Manager資產使用者接著會將應新增至貢獻資料夾的資產類型以及一組基準資產上傳至&#x200B;**SHARED**&#x200B;資料夾，以確保Brand Portal使用者具備所需資訊，以定義資產需求。 然後，管理員可先授與作用中Brand Portal使用者對貢獻資料夾的存取權，再將新建立的貢獻資料夾發佈至Brand Portal。

下列影片示範如何在「Experience Manager資產」中設定「貢獻」資料夾：

>[!VIDEO](https://video.tv.adobe.com/v/30547)

Experience Manager資產使用者在設定貢獻資料夾時執行下列活動：
...
* [將貢獻資料夾從Experience Manager資產發佈至Brand Portal](#publish-contribution-folder-to-brand-portal)

## 建立貢獻資料夾 {#create-contribution-folder}


Experience ManagerExperience Manager管理員和非擁有建立新資料夾權限的管理員使用者，可以在資產中建立貢獻資料夾。
...
1. 導覽至&#x200B;**[!UICONTROL Assets]** > **[!UICONTROL Files]**。 它會列出Experience Manager資產存放庫中的所有現有資料夾。
...
1. 按一下&#x200B;**[!UICONTROL 建立]**。您可以在「Experience Manager資產」存放庫中看到列出的貢獻資料夾。
...
Experience Manager資產管理員在設定貢獻資料夾的屬性時，會執行下列活動。
...
>[!NOTE]
>
>搜尋結果以在「Experience Manager資產」中設定的Brand Portal使用者清單為基礎。 請確定您有更新的Brand Portal使用者清單。
...
設定貢獻資料夾後，Experience Manager資產使用者（管理員/非管理員使用者）就可以將貢獻資料夾從Experience Manager資產發佈至Brand Portal。 擁有存取貢獻資料夾權限的Brand Portal使用者會在完成發佈動作時收到電子郵件/脈衝通知。
...
會傳送電子郵件/脈衝通知給指派給貢獻資料夾的Brand Portal使用者。 Brand Portal使用者可以存取貢獻資料夾並開始貢獻。 請參閱[將資產上傳至貢獻資料夾並發佈至Experience Manager資產](brand-portal-publish-contribution-folder-to-aem-assets.md)。
