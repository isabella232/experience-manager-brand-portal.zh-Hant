...
針對協作資產來源取得，Experience Manager Assets使用者（管理員和非擁有權限的管理員使用者）可以建立類型&#x200B;**資產貢獻**&#x200B;的新資料夾，確保所建立的新資料夾可供Brand Portal使用者提交資產。  這會自動觸發在新建立的&#x200B;**Contribution**&#x200B;資料夾內建立另外兩個子資料夾（稱為&#x200B;**SHARED**&#x200B;和&#x200B;**NEW**）的工作流程。

接著，Experience Manager Assets使用者將應新增至貢獻資料夾的資產類型以及一組基準資產上傳至&#x200B;**SHARED**&#x200B;資料夾，以確保Brand Portal使用者具備所需資訊，以定義資產需求。 然後，管理員可先授與作用中Brand Portal使用者對貢獻資料夾的存取權，再將新建立的貢獻資料夾發佈至Brand Portal。
...
1. 導覽至&#x200B;**[!UICONTROL Assets]** > **[!UICONTROL Files]**。 它會列出Experience Manager Assets存放庫中的所有現有資料夾。
...
會傳送電子郵件/脈衝通知給指派給貢獻資料夾的Brand Portal使用者。 Brand Portal使用者可以存取貢獻資料夾並開始貢獻。 請參閱[將資產上傳至貢獻資料夾並發佈至Experience Manager Assets](brand-portal-publish-contribution-folder-to-aem-assets.md)。
