...
品牌入口網站使用者可以[下載資產需求](brand-portal-download-asset-requirements.md)以瞭解貢獻的需要。
...
>
>如果您需要將品牌入口網站的上傳限制擴充至&#x200B;**10** GB以上，請連絡Adobe支援，指定需求。
...
將所有資產或檔案夾上傳至「NEW」檔案夾後，將貢獻檔案夾發佈至「AEM資產」。 請參閱「將貢獻資料夾發佈至AEM Assets[」。](brand-portal-publish-contribution-folder-to-aem-assets.md)
