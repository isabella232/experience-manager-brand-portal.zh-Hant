...
## 2023.05.0中的更改 {#what-changed-in-May-2023}

Brand Portal2023.05.0是一個內部版本，包含對關鍵問題的修復。 查看最新 [Brand Portal發行說明](brand-portal-release-notes.md)。

## 2023.02.0中的更改 {#what-changed-in-February-2023}

Brand Portal2023.02.0是一個內部版本，包含對關鍵問題的修復。 查看最新 [Brand Portal發行說明](brand-portal-release-notes.md)。

## 2022.10.0中的更改 {#what-changed-in-October-2022}

Brand Portal2022.10.0是一個內部版本，包含對關鍵問題的修復。 查看最新 [Brand Portal發行說明](brand-portal-release-notes.md)。

## 2022.08.0中的更改 {#what-changed-in-August-2022}

Brand Portal2022.08.0是一個內部版本，包含對關鍵問題的修復。 查看最新 [Brand Portal發行說明](brand-portal-release-notes.md)。
...
資產（和資料夾）從AEM6.4.2.0發佈工作流可以安排在以後的日期、時間將作者實例發佈到Brand Portal。
