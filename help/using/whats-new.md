...
早些時候，AEM Assetsas a Cloud Service是使用Adobe開發人員控制台手動配置的。
...
Brand Portal具有適當權限的用戶可以下載資產要求以瞭解捐贈的需要，並將包含多個資產的多個資產或資料夾上載到捐贈資料夾。 但請注意，Brand Portal用戶只能將資產上載到 **新建** 子資料夾。 的 **共用** 資料夾用於分配需求和基準資產。
