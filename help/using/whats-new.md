...
**Qus。 我是否會失去對已建立的任何現有資產、功能或設定的存取權？**
阿**斯。** 您現有的所有功能和組態都保持不變。 您的使用者不受影響，而您的內容將保持不變。

**客戶。 我何時要改用新版的Brand Portal?**
阿**斯。** 品牌入口網站6.4.4已於2019年2月發行生產。 下一個品牌入口網站版本預計將於2019年第3季度推出。
...
**客戶。 我的使用者是否會受到影響？**
阿**斯。** 這項變更僅限在品牌入口網站內，因此對您的使用者沒有影響。

**客戶。 我需要採取什麼動作？**
阿**斯。** 管理員不需要執行任何操作。 在您存取新品牌入口網站後，請參閱檔案以檢視所有的技巧。

**客戶。 我要與誰聯絡有問題？**
阿**斯。** 請聯絡您的Adobe客戶經理或客戶支援。
